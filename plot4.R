...
###
### Plot #4 - Produce 4 graphs in 2 rows, 2 columns
###
...
###
### Plot #4A - line diagram of Global Active Power values across 2 days by minute
###
plot(PlotData$Time,PlotData$Global_active_power,
     type="l",
     col="black", 
     fg="black",
     main="Global Active Power by Minute",
     xlab="",
     ylab="Global Active Power (kilowatts)")

###
### Plot #4B - line diagram of Voltage values across 2 days by minute
###
plot(PlotData$Time,PlotData$Voltage,
     type="l",
     col="black", 
     fg="black",
     main="Voltage by Minute",
     xlab="",
     ylab="Voltage")

###
### Plot #4C - line diagram comparing energy sub metering readings
###           across 2 days by minute
###
plot(PlotData$Time,PlotData$Sub_metering_1,type="l",col="black", 
     fg="black",
     main="Sub Metering Readings by Minute",
     xlab="",
...
###
### Plot #4D - line diagram of Global Reactive Power values across 2 days by minute
###
plot(PlotData$Time,PlotData$Global_reactive_power,
     type="l",
     col="black", 
     fg="black",
     main="Global Reactive Power by Minute",
     xlab="",
